...
import org.tduc.scheduleservice1.service.ScheduleParticipantService;
...
public class ScheduleParticipantController {
    ...
    public ResponseEntity<?> createScheduleParticipant(@RequestBody @Valid ScheduleParticipantCreationRequest request) {
        org.tduc.scheduleservice1.dto.request.ApiResponse<ScheduleParticipant> response = new org.tduc.scheduleservice1.dto.request.ApiResponse<>();
    ...
    public ResponseEntity<?> getScheduleParticipants() {
        org.tduc.scheduleservice1.dto.request.ApiResponse<List<ScheduleParticipant>> response = new org.tduc.scheduleservice1.dto.request.ApiResponse<>();
        response.setCode(HttpStatus.OK.value());
    ...
    public ResponseEntity<?> getMyEnrollments() {
        org.tduc.scheduleservice1.dto.request.ApiResponse<List<ScheduleCreationResponse>> response = new org.tduc.scheduleservice1.dto.request.ApiResponse<>();
